/-!
# smooth-4-dimensional-poincare-conjecture-canonical-lane Lean migration boundary
...
`Smooth4DimensionalPoincareConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "smooth-4-dimensional-poincare-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/smooth-4-dimensional-poincare-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Smooth 4-Dimensional Poincare Conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["geometric-topology", "mathematical-proof", "reproducibility", "topology", "4-manifolds", "smooth-4-dimensional-poincare-conjecture", "smooth-structures", "canonical-lane", "local-to-global", "manifold-constrained"]
